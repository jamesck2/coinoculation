...
p.plot <- ggplot(emmeans_all, aes(x=significance, y=trait, group=contrast, color=contrast)) +
...
```{r}
# All treatments and controls
(boxplot.root_mass.all <- ggplot(tp_all , aes(x=treatment, y=root_mass)) +
  geom_boxplot() +
  xlab("Treatment") +
  ylab("Root mass (g)") +
  #ggtitle("Average nodule count per plant at week 4") +
...
# 141 and co-inoculated only
(boxplot.root_mass <- ggplot(tp_all %>% filter(treatment == c("141", "522co141", "702co141", "717co141", "733co141")), aes(x=treatment, y=root_mass)) +
  geom_boxplot() +
  xlab("Treatment") +
  ylab("Root mass (g)") +
  #ggtitle("Average nodule count per plant at week 4") +
...
```{r}
# All treatments and controls
(boxplot.ratio.all <- ggplot(tp_all , aes(x=treatment, y=ratio)) +
  geom_boxplot() +
  xlab("Treatment") +
...
# 141 and co-inoculated only
(boxplot.ratio <- ggplot(tp_all %>% filter(treatment == c("141", "522co141", "702co141", "717co141", "733co141")), aes(x=treatment, y=ratio)) +
  geom_boxplot() +
  xlab("Treatment") +
  ylab("Shoot:root mass ratio") +
  #ggtitle("Average nodule count per plant at week 4") +
...
```{r}
# All treatments and controls
(boxplot.height4.all <- ggplot(tp_all , aes(x=treatment, y=height4)) +
  geom_boxplot() +
  xlab("Treatment") +
...
# 141 and co-inoculated only
(boxplot.height4 <- ggplot(tp_all %>% filter(treatment == c("141", "522co141", "702co141", "717co141", "733co141")), aes(x=treatment, y=height4)) +
  geom_boxplot() +
  xlab("Treatment") +
  ylab("Shoot height (cm)") +
  #ggtitle("Average nodule count per plant at week 4") +
...
```{r}
# All treatments and controls
(boxplot.chloro4.all <- ggplot(tp_all , aes(x=treatment, y=chloro4)) +
  geom_boxplot() +
  xlab("Treatment") +
...
# 141 and co-inoculated only
(boxplot.chloro4 <- ggplot(tp_all %>% filter(treatment == c("141", "522co141", "702co141", "717co141", "733co141")), aes(x=treatment, y=chloro4)) +
  geom_boxplot() +
  xlab("Treatment") +
  ylab("Chlorophyll content (SPAD)") +
  #ggtitle("Average nodule count per plant at week 4") +
...
```{r}
# boxplot, all treatments and controls
(boxplot.nod_mass.all <- ggplot(tp_all, aes(x=treatment, y=(nod_mass)*1000)) +
  geom_boxplot() +
  xlab("Treatment") +
...
plot(boxplot.nodule_mass.all)
save_plot("./figures/boxplot_nod_mass_all.png", boxplot.nod_mass.all, base_asp = 3)

# boxplot, 141 and co-inoculated treatments only
(boxplot.nod_mass <- ggplot(tp_all %>% filter(treatment == c("141", "522co141", "702co141", "717co141", "733co141")), aes(x=treatment, y=(nod_mass)*1000)) +
  geom_boxplot() +
  xlab("Treatment") +
  ylab("Average nodule mass (mg)") +
  #ggtitle("Average nodule count per plant at week 4") +
